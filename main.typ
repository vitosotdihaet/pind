...
Описание показателей качества определяет количественные и качественные характеристики, по которым оценивается соответствие разрабатываемого ПО установленным требованиям. Это необходимо для объективной оценки готовности системы к внедрению и для определения критериев приемки на этапе испытаний (глава @testing).
...
== Показатели качества ПО по ГОСТ Р ИСО/МЭК 25010 <quality-gost>
...
== Итог
Разработанный перечень показателей качества представляет собой формализованное описание метрик, по которым будет оцениваться успешность реализации плагина глобального вторичного индекса. Артефакт включает две группы показателей:
